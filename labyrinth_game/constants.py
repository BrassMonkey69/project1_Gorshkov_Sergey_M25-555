ROOMS = {
    ...
    'library': {
          ...
          'exits': {'east': 'hall', 'north': 'armory', 'east': 'trophy_room'},
          'items': ['ancient_book'],
    ...
    'laboratory': {
          'description': 'Много битого стекла. В воздухе чувствуется химический привкус. На столе лежат уцелевшие склянки с жидкостями, на одной из таких напись гласит "C2H5OH, 100 мл."',
          'exits': {'east': 'trap_room', 'north': 'trophy_room'},
          'items': ['vial'],
          'puzzle': ('Дверь защищена кодом. Введите код (подсказка: в этот день родилась самая лучшая мышь - это простое число почти посередине месяца)', '17')
    },
    'trophy_room': {
          'description': 'Посреди комнаты лежит мягкий, но пыльный ковер из гризли, со стены на Вас смотрит голова оленя.',
          'exits': {'south': 'laboratory', 'east': 'library'},
          'items': ['crossbow'],
          'puzzle': ('none')
    },
} 